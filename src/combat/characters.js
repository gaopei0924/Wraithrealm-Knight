...
export const CHARACTERS = {
  knight: {
    ...
    desc: '均衡的全能戰士，單手劍三連擊。',
    icon: 'attack', signature: 'slam', attackStyle: 'sword',
  ...
  barbarian: {
    ...
    desc: '雙手重武，緩慢但大範圍高傷、強力擊退。',
    icon: 'shockwave', signature: 'shockwave', attackStyle: 'heavy',
  ...
  mage: {
    ...
    desc: '遠距奧術轟擊，法力充沛但生命脆弱。',
    icon: 'fireball', signature: 'fireball', attackStyle: 'mage',
    stats: { maxHp: 0.75, damageMult: 1.0, moveSpeed: 1.0, critChance: 0.05, lifesteal: 0, mpRegen: 1.8 },
  },
  rogue: {
    id: 'rogue', name: '遊俠', subtitle: 'RANGER', model: 'Rogue',
    desc: '遠距射手，連珠箭矢、高速高暴擊。',
    icon: 'dash', signature: 'dash', attackStyle: 'bow',
  ...
  warden: {
    ...
    desc: '雙刀吸血，越戰越強。',
    icon: 'bloodlust', signature: 'poison', attackStyle: 'dual',
  ...
  bonelord: {
    ...
    desc: '不死的亡域之主，雙手重擊、附帶連鎖閃電。',
    icon: 'chain', signature: 'chain', attackStyle: 'heavy',
  ...
  zombie: {
    ...
    desc: '緩慢但血厚的不死者，重擊揮砍、附帶劇毒。',
    icon: 'poison', signature: 'poison', attackStyle: 'heavy',
  ...
  vampire: {
    ...
    headNode: 'head', modelScale: 0.92, aliases: GRAVE_ALIASES,
    desc: '貴族吸血鬼，雙手連擊、吸血強、招牌嗜血狂暴。',
    icon: 'bloodlust', signature: 'bloodlust', attackStyle: 'heavy',
  ...
  reaper: {
    ...
    headNode: 'head', modelScale: 0.92, aliases: GRAVE_ALIASES,
    desc: '敏捷的骷髏，雙手快速連擊、高暴擊，招牌連鎖閃電。',
    icon: 'chain', signature: 'chain', attackStyle: 'dual',
  ...
  wraith: {
    ...
    desc: '飄渺難捉，遠距冰霜彈、閃避極高、生命脆弱。',
    icon: 'frost', signature: 'frost', attackStyle: 'mage',
